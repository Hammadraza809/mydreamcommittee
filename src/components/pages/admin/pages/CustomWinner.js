...
const customwinner = [
    {
        label: "Plase Select Option", value: ''
    },
    {
...
function CustomWinner(props) {
    ...
    const setCustomwin = data => {
        ...
        fetch(`https://mydreamcommittee.com/v1/user/${data.membershipId}`, {
            method: 'PATCH',
            headers: {
                                ...
                                <Row>
                                    <Col className={classes.root}>
                                        ...
                                        <Field
                                            ...
                                            variant='outlined'
                                        />
                                        {<div style={{ color: 'red' }}><small>{errors.membershipId}</small></div>}
                                    </Col>
                                    <Col className={classes.root}>
                                        ...
                                        {<div style={{ color: 'red' }}><small>{errors.customwinner}</small></div>}
                                    </Col>
                                    <Col className={classes.root}>
                                        <Button
                                            style={{
